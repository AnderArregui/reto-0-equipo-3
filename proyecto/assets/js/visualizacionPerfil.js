...
function perfil(usuario) {
    fetch('/view/usuario/perfil/verperfil.html.php', {
        method: 'POST',
        headers: {
...
function obtenerPreguntasPorUsuario(posts) {
    fetch('/view/usuario/preguntas/gestionarpreguntas.html.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function obtenerRespuestasPorUsuario(respuestas) {
    fetch('/view/usuario/respuestas/gestionarrespuestas.html.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
