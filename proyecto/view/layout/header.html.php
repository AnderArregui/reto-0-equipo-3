...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/Claro/headerFooterClaro.css">

    <link rel="stylesheet" href="/assets/css/inicio.css">
    <link rel="stylesheet" href="/assets/css/Claro/inicioClaro.css">

    <link rel="stylesheet" href="/assets/css/perfil.css">
    <link rel="stylesheet" href="/assets/css/temas.css">

    <link rel="stylesheet" href="/assets/css/contacto.css">
    <link rel="stylesheet" href="/assets/css/Claro/contactoClaro.css">

    <link rel="stylesheet" href="/assets/css/CrearPregunta.css">
    <link rel="stylesheet" href="/assets/css/Claro/CrearPreguntaClaro.css">

    <link rel="stylesheet" href="/assets/css/resultado.css">
    <link rel="stylesheet" href="/assets/css/mostrarUsuario.css">
...
<nav>
    ...
    <div class="search-container">
        <form action="index.php" method="GET">
            ...
            <button type="submit">
                <img src="/assets/images/search.svg" alt="Lupa" class="search-icon">
            </button>
        </form>
    </div>
        ...
        <div class="dropdown-menu">
            <ul>
                ...
                <li>
                    ...
                    <a href="/assets/pdfs/guia_usuario.pdf" target="_blank">Ayuda</a>
                ...
                <li>
                    ...
                    <a href="/assets/pdfs/guia_admin.pdf" target="_blank">Ayuda Admin</a>
