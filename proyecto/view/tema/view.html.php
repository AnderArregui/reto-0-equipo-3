    ...
    <h3><?php echo htmlspecialchars($temas['nombre']); ?></h3>
        ...
        <div class="preguntas"> 
            ...
            <?php if (!empty($preguntas)): ?>
                ...
                <img src="<?php echo $guardados[$pregunta['id_post']] ? '/assets/images/save.png' : '/assets/images/nosave.png'; ?>" alt="Guardar" class="save-icon" data-id-post="<?php echo $pregunta['id_post']; ?>" data-id-usuario="<?php echo $_SESSION['usuario']['id_usuario']; ?>" onclick="guardar(this)" />
            </div>
                <?php endforeach; ?>
            <?php else: ?>
