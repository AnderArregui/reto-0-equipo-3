    ...
    if ($id_post): 
        ...
        if ($post): ?>
            <div class="preguntaBlanca" style="border: 2px dashed <?php echo htmlspecialchars($temas['caracteristica']); ?>">
                ...
                <img src="<?php echo $guardado ? '/assets/images/save.png' : '/assets/images/nosave.png'; ?>" alt="Guardar" class="save-icon" data-id-post="<?php echo $post['id_post']; ?>" data-id-usuario="<?php echo $_SESSION['usuario']['id_usuario']; ?>" onclick="guardar(this)" />

            </div>
            <form action="/index.php?controller=Post&action=publicarRespuesta" method="POST" enctype="multipart/form-data" class="respuestaForm">
                <input type="hidden" name="id_post" value="<?php echo htmlspecialchars($id_post); ?>">
                <input type="text" name="contenido" placeholder="Postea tu respuesta" required>
                
                <div class="file-input-container">
                    <input type="file" id="media" name="media" accept="image/*,video/*,application/pdf" class="file-input">
                    <label for="media" class="custom-file-label">
                        <img src="/assets/images/archivo.png" alt="Adjuntar archivo" class="file-icon">
                        <h4>o</h4>
                        <img src="/assets/images/pdf.png" alt="Adjuntar PDF" class="file-icon">
    ...
    <?php foreach ($respuestas as $respuesta): ?>
        <div class="respuesta">
            ...
            <?php if ($respuesta['ruta_media']): ?>
                ...
                <?php elseif (strpos($respuesta['ruta_media'], '.pdf') !== false): ?>
                    <a href="<?php echo htmlspecialchars($respuesta['ruta_media']); ?>" target="_blank" class="orden-control" style="width:fit-content; font-weight:500">Ver PDF</a>
                <?php else: ?>
            ...
            <div class="postInfo">
    <img src="<?php echo $respuesta['liked_by_user'] ? '/assets/images/like.png' : '/assets/images/nolike.png'; ?>" alt="Like" 
        class="like-icon" 
