...
<div class="general">
    <div class="container">
        ...
        <script src="/assets/js/degradado.js"></script>
    ...
    <?php while ($contador < $preguntasPorPagina && $contador < count($preguntas)): ?>
        ...
        <div class="pregunta" style="border: 2px dashed <?php echo htmlspecialchars($pregunta['caracteristica']); ?>">
            <h3>
                ...
                <img src="<?php echo $isSaved ? '/assets/images/save.png' : '/assets/images/nosave.png'; ?>" alt="Guardar" class="save-icon" data-id-post="<?php echo $pregunta['id_post']; ?>" data-id-usuario="<?php echo $_SESSION['usuario']['id_usuario']; ?>" onclick="guardar(this)" />
...
<aside>
            ...
            if (!empty($likesUsuario)): ?>
                <?php foreach ($likesUsuario as $respuestaLike): ?>
                    <div class="divUsuario" style="border: 2px dashed <?php echo htmlspecialchars($respuestaLike['caracteristica']); ?>">
                        ...
                        <?php if (!empty($respuestaLike['ruta_media'])): ?>
                            <?php if (strpos($respuestaLike['ruta_media'], '.pdf') !== false): ?>
                                <br><br>
                                <a href="<?php echo htmlspecialchars($respuestaLike['ruta_media']); ?>" target="_blank" class="orden-control" style="width:fit-content; font-weight:500;border:2px dashed white">Ver PDF</a>
                            <?php elseif (strpos($respuestaLike['ruta_media'], '.mp4') !== false || strpos($respuestaLike['ruta_media'], '.webm') !== false || strpos($respuestaLike['ruta_media'], '.ogg') !== false): ?>
                                <br><br>
                                <video controls style="max-width: 100%; max-height: 200px;">
                                    <source src="<?php echo htmlspecialchars($respuestaLike['ruta_media']); ?>" type="video/mp4">
                                    Tu navegador no soporta el video.
                                </video>
                            <?php elseif (strpos($respuestaLike['ruta_media'], '.jpg') !== false || strpos($respuestaLike['ruta_media'], '.png') !== false || strpos($respuestaLike['ruta_media'], '.webp') !== false): ?>
                                <br><br>
    ...
    <div class="botonMas">
        <a href="/index.php?controller=Post&action=crearPregunta">
            <img src="/assets/images/crear.svg" alt="Añadir pregunta">
        </a>
    </div>
