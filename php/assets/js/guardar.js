function guardar(icon) {
    ...
    const idUsuario = icon.getAttribute('data-id-usuario'); // Obtener el id de usuario directamente
    ...
    fetch('index.php?controller=Guardado&action=guardar', {
        ...
        body: JSON.stringify({ id_post: idPost, id_usuario: idUsuario, guardar: isSaving })
    })
    .then(response => {
