function like(icon) {
    ...
    const newIconSrc = isLiking 
        ? '/reto-1-equipo-3/php/assets/images/like.png' // Cambia a like.png si el usuario da like
        : '/reto-1-equipo-3/php/assets/images/nolike.png'; // Cambia a nolike.png si el usuario quita el like
    ...
    .catch(error => {
        ...
        icon.src = icon.src.includes('nolike.png') 
            ? '/reto-1-equipo-3/php/assets/images/like.png' 
            : '/reto-1-equipo-3/php/assets/images/nolike.png';
    });
}
